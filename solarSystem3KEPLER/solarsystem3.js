...
const createScene = function () {
    ...
    const celestialData = [
        {
            ...
            rotationSpeed: 0.4, 
            moons: [
                { name: "Kepler-47 b", size: 1.4, distance: 50, orbitSpeed: 0.02, rotationSpeed: 0.4, texture: "https://raw.githubusercontent.com/razvanpf/Images/main/Kepler47b.png", type: "planet" },
                { name: "Kepler-47 c", size: 1.1, distance: 80, orbitSpeed: 0.02, rotationSpeed: 0.4, texture: "https://raw.githubusercontent.com/razvanpf/Images/main/Kepler47c.png", type: "planet", eccentricity: 0.25, inclination: 17 },
                { name: "Kepler-47 d", size: 0.8, distance: 120, orbitSpeed: 0.02, rotationSpeed: 0.4, texture: "https://raw.githubusercontent.com/razvanpf/Images/main/Kepler47d.png", type: "planet" }
            ],
            type: "star",
        },
        {
    ...
    celestialData.forEach((data, index) => {
        ...
        if (data.type === "star") {
            ...
            // Adjust the color for Kepler-47 B
            if (data.name === "Kepler-47 B") {
...
function attachShipToPlanet(ship, planet) {
    ...
    function showPopup(mesh) {
        ...
        const planetDescriptions = {
            "Kepler-47 A": {
                name: "Kepler-47 A",
                description: "Kepler-47 A is the larger of the two stars in this binary system, a majestic yellow dwarf radiating a warm, steady light. It serves as the primary anchor of this multi-planetary system, with its gravity guiding the orbits of the surrounding celestial bodies.",
            ...
            "Kepler-47 B": {
                name: "Kepler-47 B",
                description: "Kepler-47 B is a dimmer, smaller orange dwarf star that orbits alongside its larger companion, Kepler-47 A. Despite its smaller size, it plays a crucial role in shaping the dynamics of the system, creating complex gravitational interactions.",
            ...
            "Kepler-47 b": {
                name: "Kepler-47 b",
                description: "Kepler-47 b is a gas giant with a thick atmosphere primarily composed of carbon dioxide and nitrogen. It boasts a striking appearance with its swirling clouds and dynamic weather systems, making it a prominent feature of the system.",
                image: "https://raw.githubusercontent.com/razvanpf/Images/main/2D%20Solar%20System%20Textures/Kepler47b.png",
                age: "4.85 billion years",
                mass: "0.123 × 10^30 kg",
            ...
            "Kepler-47 c": {
                name: "Kepler-47 c",
                description: "Kepler-47 c is a vibrant planet known for its eccentric orbit and unique characteristics. It possesses a surface rich in various elements and compounds, creating a diverse and colorful landscape under its thin atmosphere.",
            ...
            "Kepler-47 d": {
                name: "Kepler-47 d",
                description: "Kepler-47 d, the outermost planet in this system, is a terrestrial planet with a stable orbit. It features a rocky surface and an atmosphere dominated by carbon dioxide and nitrogen, making it a subject of interest for studying planetary atmospheres.",
                image: "https://raw.githubusercontent.com/razvanpf/Images/main/2D%20Solar%20System%20Textures/Kepler47d.png",
                age: "4.85 billion years",
                mass: "1.27 × 10^25 kg",
                atmosphere: "Carbon Dioxide, Nitrogen",
                diameter: "12,742 km",
